# submit_tuning_job_salesfit.py
"""Submit Optuna tuning for sales_lift_pct specifically."""
...
IMAGE_URI = "us-central1-docker.pkg.dev/promo-roi-platform-2026/ml-repo/promo-training:v11"
...
def submit_job():
    ...
    job = aiplatform.CustomContainerTrainingJob(
        display_name="promo-roi-tuning-sales-lift-pct",
        container_uri=IMAGE_URI,
        command=["python", "tune.py"],
    )

    print("Submitting tuning job for sales_lift_pct...")
